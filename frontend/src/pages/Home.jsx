...
const heroSlides = [
  {
    id: 'hero1',
    image: '/hero_flowers_bunch.png',
    badge: 'By MD FLOWER • Est. 1998',
    heading: 'Luxury',
    headingGold: 'Floristry',
    sub: "Experience the world's most exquisite floral artistry. Hand-crafted bouquets and arrangements curated for your precious moments.",
  },
  {
    id: 'hero2',
  ...
  },
  {
    ...
    heading: 'Enchanted',
    headingGold: 'Hanging Creepers',
    sub: 'Drape your ceilings and walls with exquisite hanging florals and lush green creepers that capture attention.',
  },
  {
    id: 'hero4',
    image: '/hero_sticks.png',
    badge: 'Artisan Sticks',
    heading: 'Bespoke',
    headingGold: 'Floral Sticks',
    sub: 'Elegant and tall decorative willow branches and flower sticks to add height and grace to your interiors.',
  },
  {
    id: 'hero5',
    ...
    heading: 'Timeless',
    headingGold: 'Candles Decor',
    sub: 'Set the perfect mood with elegant taper candles and bespoke luxury table decor designed for intimacy.',
  },
  {
    id: 'hero6',
    image: '/hero_stage_stands.png',
    badge: 'Wedding stage & stands',
    heading: 'Grand',
    headingGold: 'Floral Stage',
    sub: 'Exquisite pedestals, backdrops, and flower stands crafted to make your stage look absolutely royal.',
  },
  {
    id: 'hero7',
    image: '/hero_jhumar.png',
    badge: 'Ceiling Masterpieces',
    heading: 'Luxury',
    headingGold: 'Jhumar Hanging',
    sub: 'Stunning hanging flower chandeliers (jhumar) adorned with premium white orchids and sparkling crystals.',
  },
];
